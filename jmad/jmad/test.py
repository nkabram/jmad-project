...
class StudentTestCase(LiveServerTestCase):
    ...
    def test_student_find_solos(self):
        ...
        # He knows he's in the right place becasue she can see
        ...
        # He see the inputs of the search form, including
        # labels and placeholders.

        # He types in the name of his instrucment and submits it
        ...
        # he also sees the start tie and end time of the solo.
